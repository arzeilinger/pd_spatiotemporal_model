...
base = 0 # Baseline vector density
...
for(t in 1:Tmax){
  ...
  for(iiSusceptible in Susceptible_ind){
    ...
    kappa_t <- atm1*Infecteds_tm1/numPlants # Time-dependent proportion vectors infectious
    ...
    ## If cumulative lambda (i.e., disease preassure) exceeds Q (i.e., Sellke threshold) plant becomes infected,
...
#### Dynamics of external and secondary infection rates, and in-field vector densities
